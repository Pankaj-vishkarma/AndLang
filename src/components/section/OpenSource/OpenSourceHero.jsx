    ...
    return (
        <section className="relative w-full bg-[#071421] overflow-hidden">
            ...
            <div
                ...
                style={{ background: "radial-gradient(circle, rgba(20,120,70,0.45) 0%, transparent 70%)" }}
            />
            <div
            ...
            <div className="relative max-w-[1370px] mx-auto
                ...
                {/* ── MOBILE & TABLET ── */}
                <div className="flex flex-col lg:hidden items-center text-center gap-[20px]">

                    {/* EYEBROW */}
                    <p className="text-white/50 text-[11px] font-medium tracking-[4px] uppercase">
                        Jump Start Your Growth
                    </p>

                    {/* HEADING */}
                    <h1 className="text-white text-[28px] leading-[44px] font-bold tracking-[-0.5px]">
                        We Do
                        <br />
                    ...
                    {/* BODY TEXT */}
                    <p className="text-white/80 text-[13px] leading-[24px]">
                        <span className="font-bold">A Norwegian Based Digital Agency</span>{" "}
                        Passionate About Storytelling, Visual Design, And Technology 🚀.
                    </p>

                    {/* CTA BUTTON */}
                    <div className="mt-[8px]">
                        <button className="flex items-center gap-[8px] bg-[#FF4D1C] hover:bg-[#e84318] text-white text-[13px] font-semibold px-[24px] py-[11px] rounded-full transition-all duration-300">
                ...
                {/* ── DESKTOP — UNCHANGED ── */}
                <div className="hidden lg:flex flex-col items-center text-center gap-[28px]">
