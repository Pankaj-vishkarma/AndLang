...
const MeetTeam = () => {
    return (
    <section className="relative overflow-hidden bg-white dark:bg-[#171B2D]">
        ...
        <div className="relative z-10 max-w-[1440px] mx-auto
            ...
            <div className="max-w-[520px]">
                <h2 className="text-[#171B2D] dark:text-white
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3
                ...
                {teamMembers.map((member) => (
                    <div key={member.id} className="flex flex-col items-center text-center">
                        ...
                        <h3 className="text-[#171B2D] dark:text-white
                        ...
                        <div className="flex items-center gap-[12px] sm:gap-[14px] lg:gap-[18px] mt-[12px] sm:mt-[14px] lg:mt-[18px] text-[#171B2D] dark:text-white">
