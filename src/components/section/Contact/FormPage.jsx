    ...
    return (
        <div className="min-h-screen bg-[#0d1117] text-white">
                    ...
                    <div className="flex items-start justify-between gap-16 mb-20">
                        ...
                        <div className="w-[45%] pt-10">
                            ...
                            <div className="flex items-center gap-2">
                                <a href="mailto:contact@andlang.com" className="text-[#4ADE80] text-sm underline underline-offset-2">
                                    contact@andlang.com
                                </a>
                                <button onClick={copyEmail} title="Copy email" className="text-gray-400 hover:text-[#4ADE80] transition-colors">
                                    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            {/* ═══════════════════════════════════════════════
                ...
                Order from screenshot (top → bottom):
                1. Heading "Contact Us"
                2. Description text
                3. "Email Us at:" + email + copy icon
                4. Office image (full width)
                5. Address / Contact Details / Opening Hours
                6. Form (full width)
            ═══════════════════════════════════════════════ */}
            <div className="lg:hidden">
                <div className="max-w-[700px] mx-auto px-5 py-10 sm:px-4 sm:py-8">
                    ...
                    <div className="w-full mb-10">
                        <img src={officeImg} alt="Office" className="w-full h-[220px] sm:h-[180px] object-cover" />
                    </div>
