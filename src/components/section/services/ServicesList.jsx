                        ...
                        <div key={index}>
                            ...
                            <div className="flex flex-col lg:hidden py-[28px] sm:py-[36px] gap-[12px] sm:gap-[14px]">
                                ...
                                <div className="flex items-baseline gap-[12px] sm:gap-[16px]">
                                    ...
                                    <span className={`text-[20px] sm:text-[24px] font-bold leading-none ${service.active ? "text-[#42FFB3]" : "text-white"}`}>
                                        {service.number}
                                    </span>

                                    <h3 className={`text-[20px] sm:text-[24px] font-bold leading-tight ${service.active ? "text-[#42FFB3]" : "text-white"}`}>
                                        {service.title}
                                    </h3>
                                ...
                                {/* MORE INFORMATION */}
                                <button className={`text-[12px] sm:text-[13px] font-semibold hover:opacity-70 transition underline underline-offset-4 text-left w-fit ${service.active ? "text-[#FF4D1C]" : "text-white"}`}>
                                    More Information
                                </button>
