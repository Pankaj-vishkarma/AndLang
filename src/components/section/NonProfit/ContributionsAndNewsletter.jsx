        ...
        <>
            ...
            <section className="w-full bg-[#071421]">
                <div className="max-w-[1370px] mx-auto px-[45px] pt-[80px] pb-[90px]">
                    ...
                    {/* LOGOS ROW */}
                    <div className="flex items-center justify-center gap-[70px] flex-wrap">
                        ...
                        <div className="flex flex-col gap-[10px] max-w-[420px]">
                            ...
                            <p className="text-[#071421]/80 text-[13px] leading-[22px]">
                                ...
                                <span className="font-bold">
                                    We are dedicated to make the world a better place
                                </span>{" "}
                                and hope you would like to subscribe to our newsletter. We will never spam you, promise!
                            </p>
                        </div>
