    ...
    return (
        <section className="w-full font-graphit bg-white dark:bg-[#071421]">
            <div className="max-w-3xl mx-auto px-6 pt-16 pb-20 flex flex-col items-center text-center">
                ...
                {/* Spaced subtitle */}
                <p
                    className="text-black/50 dark:text-white/50 uppercase mb-8"
                ...
                {/* Main heading */}
                <h1
                    className="text-[#171B2D] dark:text-white font-bold mb-12"
                    style={{
                ...
                {/* Body copy */}
                <div
                    className="text-center space-y-6 max-w-2xl text-black/55 dark:text-[#b0bfcc]"
